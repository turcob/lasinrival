...
CREATE OR REPLACE FUNCTION public.pos_registrar_venta(
  ...
  p_cliente_movimiento jsonb DEFAULT NULL,
  p_empleado_movimiento jsonb DEFAULT NULL,
  p_transferencia jsonb DEFAULT NULL,
  p_cheque jsonb DEFAULT NULL,
  p_motivo_inventario text DEFAULT 'Venta',
  p_editing_pedido_id uuid DEFAULT NULL
)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
