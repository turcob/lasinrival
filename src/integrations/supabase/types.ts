  ...
  public: {
    Tables: {
      ...
      transferencias: {
        ...
        Relationships: [
          {
            foreignKeyName: "transferencias_cliente_id_fkey"
            columns: ["cliente_id"]
            isOneToOne: false
            referencedRelation: "clientes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "transferencias_cliente_movimiento_id_fkey"
            columns: ["cliente_movimiento_id"]
            isOneToOne: false
            referencedRelation: "cliente_movimientos"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "transferencias_cobro_id_fkey"
            columns: ["cobro_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "transferencias_venta_id_fkey"
            columns: ["venta_id"]
            isOneToOne: false
            referencedRelation: "ventas"
            referencedColumns: ["id"]
